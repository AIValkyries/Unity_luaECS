...
public static class LuaBinder
{
	public static void Bind(LuaState L)
	{
		...
		GameWorldWrap.Register(L);
		ProtobufDataConfigSystemsWrap.Register(L);
		ResourcesSceneSystemsWrap.Register(L);
		ResourcesSystemsWrap.Register(L);
		TcpNetworkSystemsWrap.Register(L);
		...
		L.EndModule();
		L.EndModule();
		L.BeginModule("Entitas");
		Entitas_FeatureWrap.Register(L);
		Entitas_SystemsWrap.Register(L);
		L.BeginModule("Unity");
		L.BeginModule("VisualDebugging");
		Entitas_Unity_VisualDebugging_DebugSystemsWrap.Register(L);
		L.EndModule();
		L.EndModule();
		L.EndModule();
