...
";
        ...
        const string CONTEXT_PROPERTY_TEMPLATE =
            @"    
    private ${Context}Context _${context};
    public static ${Context}Context ${context} { get{return sharedInstance._${context};} }";
        const string CONTEXT_LIST_TEMPLATE = @"_${context}";
        const string CONTEXT_ASSIGNMENT_TEMPLATE = @"        _${context} = new ${Context}Context();";
