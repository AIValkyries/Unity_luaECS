...
public partial class ${Context}Context {
    ...
    public ${Context}Entity Set${Name}() {
        if(has${Name}) {
    ...
    public void Replace${Name}(${Type} compoent) {
        var entity = ${name}Entity;
        if(entity == null) {
            entity = Set${Name}();
        } else {
            entity.Replace${Name}(compoent);
        }
    }
...
@"public partial class ${Context}Context {
    ...
    public ${Context}Entity ${name}Entity 
    { 
        get 
        { 
            return GetGroup(${Context}Matcher.${Name}).GetSingleEntity(); 
        }
    }
