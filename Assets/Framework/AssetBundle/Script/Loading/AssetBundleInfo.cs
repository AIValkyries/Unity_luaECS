...
public class AssetBundleInfo
{
    ...
    public void AsyncLoadAsset<T>(string fileName, AssetLoaderRequest asset) where T : UnityEngine.Object
    {
        if (_bundle == null)
            return;
    ...
    public void AsyncLoadAllAssets<T>(AssetAllLoaderRequest asset) where T : UnityEngine.Object
    {
        if (_bundle == null)
            return;
    ...
    public UnityEngine.Object LoadAsset(string fileName,System.Type type)
    {
        if (_bundle == null)
            return null;
        fileName = string.Format("{0}/{1}", "Assets", fileName);
        return _bundle.LoadAsset(fileName, type);
    }
